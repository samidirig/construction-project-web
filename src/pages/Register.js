...
import { TextField, Button, Link, Typography, InputAdornment, IconButton, Snackbar, Container } from "@mui/material";
...
import RegisterImage from "../assets/images/register_image_1.jpg"
...
export default function Register() {
  ...
  const isValidEmail = (email) => {
    const emailRegex = /(?:[a-zA-Z0-9._%+-]+)@(?:icloud\.com|gmail\.com|hotmail\.com|outlook\.com)/;
  ...
  const handleRegisterUser = async () => {
    if (!userName || !userSurname || !userEmail || !userPassword || !phoneNumber) {
  ...
  return (
    ...
    >
          ...
          <Container maxWidth='xs' sx={{ mt: 2 }}>
            <div>
              <Typography variant='h4' sx={{
                color: "#FF9843",
                textAlign: 'center'
              }}>Firma hesabınızı oluşturun ve kayıt olun</Typography>
            </div>
            <TextField
              fullWidth
              margin="normal"
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'center', marginTop: 25 }}>
              <Button
                type='submit'
                variant='contained'
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
              <Typography>
                <Link color="#FF9843" fontWeight='600' underline="hover" href="../login">Giriş yapın.</Link>
              </Typography>
            </div>
          </Container>
        </form>
      ...
      <div style={{
        ...
        <img src={RegisterImage} alt="login" style={{ width: '100%', height: '100%', maxHeight: 500, objectFit: 'contain' }} />
      </div>
    </div>
  )
}
