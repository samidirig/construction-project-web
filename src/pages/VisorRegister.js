...
import { register } from "../redux/visorAuthSlice";
...
import { addVisorCompanyWithUser } from "../config/firebase";

export default function VisorRegister() {
  ...
  const handleRegisterUser = async () => {
    ...
    try {
      ...
      if (registeredUser) {
        await addVisorCompanyWithUser(registeredUser, companyData);
      }
    } catch (error) {
        ...
        <form onSubmit={handleSubmit}>
          <Container maxWidth="xs" sx={{ mt: 2 }}>
            <div>
              ...
              >
                Firma hesabınızı oluşturun ve kayıt olun
              </Typography>
            </div>
            <TextField
              fullWidth
