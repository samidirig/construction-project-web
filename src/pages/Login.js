...
import { checkCompanyByUserEmail, getUserRoleByEmail } from "../config/firebase";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        console.error("There isn't any Institution that given to function: ", error);
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <Typography variant='h4' sx={{
            color: "#FF9843",
            textAlign: 'center'
          }}>Firma için giriş yapınız</Typography>
        </div>
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            <Typography>
              <Link color="#FF9843" fontWeight='600' underline="hover" href="../register">Yeni hesap oluştur</Link>
            </Typography>
